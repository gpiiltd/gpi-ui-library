    ...
    <div className="relative">
      <form onSubmit={handleSubmit} className="flex items-center">
        <input
          ...
          className="py-2 pl-10 text-sm text-primary_color rounded-lg border border-primary_color focus:outline-none focus:ring-1 focus:ring-primary_color w-full"
